...
WALLET_ROOT=$$PWD/swapcoinz

CONFIG += c++11

# cleaning "auto-generated" swapcoinz directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently swapcoinz has an issue with "static" build and linunwind-dev,
